...
{
    public class PatientBusiness : BaseBusiness<P_Controles, PatientContext>, IPatientBusiness
    {
        IMapper mapper;
        string categoryName;
        public PatientBusiness(PatientContext context, IConfiguration configuration) : base(context, null, configuration)
        {
